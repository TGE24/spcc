  ...
  return (
    <main className="flex-1">
      ...
      <section className="max-w-[1440px] mx-auto px-6 py-16 text-center md:px-[100px]">
        ...
        <Reveal delay={100} className="mx-auto mt-10 max-w-3xl overflow-hidden rounded-3xl group">
          <PlaceholderImage
            slot="about/history"
            label="Church interior photo"
            className="h-[300px] transition-transform duration-500 ease-out group-hover:scale-105 md:h-[500px]"
          />
        </Reveal>

        {/* Historical Images Gallery (Milestone 6) */}
        <div className="mx-auto mt-6 grid max-w-3xl grid-cols-2 gap-4 md:grid-cols-4">
          {HISTORY_GALLERY_SLOTS.map((slot, i) => (
            <Reveal key={slot} delay={i * 80} className="overflow-hidden rounded-xl group">
              <PlaceholderImage
                slot={slot}
      ...
      <section className="max-w-[1440px] mx-auto bg-gray-50 px-6 py-16 md:px-[100px]">
        ...
        <Reveal delay={100} className="mx-auto mt-12 flex max-w-4xl flex-wrap justify-center gap-4">
      ...
      <section className="max-w-[1440px] mx-auto px-6 py-16 md:px-[100px]">
        ...
        <div className="mt-12 grid gap-10 md:grid-cols-2">
          ...
          <Reveal delay={150} className="overflow-hidden rounded-2xl group">
            <PlaceholderImage slot="about/community" label="Community photo" className="h-[350px] transition-transform duration-500 ease-out group-hover:scale-105 md:h-[514px]" />
          </Reveal>
        </div>
      </section>
